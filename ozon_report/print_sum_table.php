...
foreach ($arr_for_sum_table as $key=>$data_for_print){
    ...
    echo <<<HTML
        <tr class="" >
            ...
            <td class ="$string_number_color $color_class" rowspan="{$count_string}">$summ_info</td>
...
// $i=0;
    ...
    echo "<td class =\"$string_number_color $color_class\">".number_format(round($summa_trat,0),0,'.',',')."</td>";
...
<td class="$string_number_color"></td>
<td class="$string_number_color"></td>
<td class="$string_number_color $color_class big_text">$text_summa_k_nachisleniu </td>
</tr>
