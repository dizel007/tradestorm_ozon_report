...
$arr_type_find_servives['Услуги агентов'] =
    array(
        ...
        'Страхование товара от массовых повреждений' => 'Страхование товара от массовых повреждений'
...
$arr_type_find_servives['Другие услуги и штрафы']  = array(
    ...
    'Утилизация товара: Пролились/просыпались из-за упаковки' => 'Утилизация товара: Пролились/просыпались из-за упаковки',
    ...
    'Утилизация товара' => 'Утилизация товара',
